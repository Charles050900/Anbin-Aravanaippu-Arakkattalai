                ...
                <div className="row justify-content-center">
                    ...
                    <div className="row  justify-content-center mb-4">
                        ...
                        <div className="col-6  col-lg-4  ">
                            <div className="h-100 bg-primary text-white p-3 rounded vol-shadow d-flex justify-content-center align-items-center flex-column">
                                <h5 className="mb-1 fw-bold">M. Jabadurai</h5>
                                <p className=" m-0">Advocate</p>
                                <p className="m-0"> Member of Board</p>
                            </div>
                        </div>
                        <div className="col-6 h-100 col-sm-6 col-lg-4  ">
                            <div className="bg-primary text-white p-3 rounded vol-shadow d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div className="row   justify-content-center  mb-4">
                        {/* Add more members here */}
                        <div className="col-6 col-lg-4">
                            <div className="h-100 bg-primary text-white p-3 rounded vol-shadow">
