        ...
        <div className="volunteer py-4">
            ...
            <div className="row justify-content-center ">
                <div className="col-10 col-sm-8 col-md-6 col-lg-3 text-center">
                    ...
                    <div className="row d-flex justify-content-center">
                        ...
                        <div className="org-connector-x col-lg-8 d-none d-md-block col-1 rounded   "></div>
                    </div>
                </div>
            </div>
            ...
            <div className="row justify-content-center">
                <div className="col-10 col-sm-5 col-md-4 col-lg-2 text-center ">
                    <div className="org-connector-y rounded-5 d-none d-md-block"></div>
                    <div className="org-box vol-shadow">
                        {/* <img src={pic} alt="" className="img-fluid w-50 rounded-4 mb-4" /> */}
                        <h5 className="fw-bold">K. Kamali</h5>
                        <p className="mb-0">Trustee</p>
                    </div>
                    <div className="org-connector d-none d-md-block"></div>
                </div>
            ...
            <div className="row justify-content-center ">
                <div className="col-10 col-sm-5 col-md-4 col-lg-2 text-center ">
                    ...
                    <div className="org-connector d-md-none"></div>
                </div>

                <div className="col-10 col-sm-5 col-md-4 col-lg-2 text-center  mt-md-0">
                    <div className="org-box vol-shadow">
                        {/* <img src={pic} alt="" className="img-fluid w-50 rounded-4 mb-4" /> */}
